...
#define BL_GET_RPD_STATUS 0x54
#define BL_GO_TO_ADDR 0x55
#define BL_FLASH_ERASE 0x56
#define BL_MEM_WRITE 0x57
#define BL_MEM_READ 0x58
#define BL_EN_R_W_PROTECT 0x59
#define BL_READ_SECTOR_STATUS 0x5A
#define BL_OTP_READ 0x5B
#define BL_DIS_R_RW_PROTECT 0x5C
...
#define FLASH_EN (FLASH_BASE + FLASH_SIZE)
#define BKPSRAM_SIZE 16*1024
#define BKPSRAM_END (BKPSRAM_BASE + BKPSRAM_SIZE)
#define OTP_SIZE 528
#define OTP_END (FLASH_OTP_BASE + OTP_SIZE)
